...
-- by strictly aliasing all column references, especially in the services lookup
-- where 'id' conflicted with the output parameter name.
-- Retains all logging logic.
...
BEGIN
  ...
  -- Use explicit alias 'srv' to avoid ambiguity between column 'id' and output parameter 'id'
  SELECT srv.duration_minutes INTO v_service_duration 
  FROM services srv 
